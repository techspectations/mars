...
View Fixed Deposit Transactions Of Each month
</small>
</h1>
</div><!--/.page-header-->
...
<br><br>
            <?php  echo form_open('money_c/fdepositinsert'); 
...
<table border="0" class="demo">
    ...
    <td width="200" colspan="2"><input type="submit" name="next" value="Next" class="btn btn-primary" style="margin-top: -9px;height: 32px;width: 91px;margin-left: 3px;"></td></tr></table><br><br>
...
<!--<a href="<?php echo site_url('money_c/yodlee');?>">yodlee</a>-->
