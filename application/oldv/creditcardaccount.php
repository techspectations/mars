...
View credit card Transactions Of Each month
</small>
</h1>
</div><!--/.page-header-->
...
<br><br>
            <?php  echo form_open('money_c/checkcredit'); 
            $cbal = $this->input->get('cbal');  ?>  

<table border="0" class="demo" style="">
    ...
    <tr><td width="200" colspan="2"><input type="submit" class="btn btn-primary" name="next" value="Next" style="height: 32px; width: 108px;margin-left: 542px;margin-top: -69px;"></td></tr>
</table><br><br>
