...
$data = array( 'cobSessionToken' => $cob_session_token, 'userSessionToken' => $rsession_token, 'memSiteAccId'=>'10103502');
$options = array(
    'http' => array(
...
//print_r($myArray);
//
////$flat =iterator_to_array(new RecursiveIteratorIterator(new RecursiveArrayIterator($myArray)), 0);
//print_r($myArray['identifier']);
/////////////////////////////////////
foreach ($myArray as $rows) {

    $row2=$rows['siteInfo'];
 $bank=$row2['defaultDisplayName'];
 $siteId=$row2['siteId'];
}
//////////////////////////////////////
?>
