...
View Insurance Transactions Of Each month
</small>
</h1>
</div><!--/.page-header-->
...
<br><br>
           <?php  echo form_open('money_c/insaccountinsert'); 
...
<table border="0" class="demo">
    ...
    <td><input type="submit" name="next" value="Next" class="btn btn-primary" style="height: 32px;width: 91px;margin-left: 3px;"></td></tr></table>
    <br><br>
<?php echo form_close();?>
