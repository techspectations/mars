...
echo form_open('money_c/loaninsert');  ?>  
...
<table border="0" class="demo">
    ...
    <tr><td>Day/Month/Year:</td><td><select name="day" style=" width: 60px;margin-left: -75px;">
    ...
    <tr><td colspan="2"><input type="submit" name="btn-save" id="btn-save" class="btn btn-primary" style="height: 32px;width: 91px;margin-left: 152px;" value="Save"></td></tr>
        ...
        <?php echo form_open('money_c/eloaninsert');?>
            
            <input type="submit" name="btn-save" id="btn-save" class="btn btn-primary" style="margin-left: 274px;
    margin-top: -44px;
    margin-bottom: -428px;
    height: 34px;" value="View"></td></tr>
        </table>
