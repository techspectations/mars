...
<div id="contact">
 <br/>
<?php
            $m=$this->input->get('var2');
                    $y=$this->input->get('var3');
                    $id=$this->input->get('var1');
        echo form_open('money_c/updateinsurancetable/'.$id.'/'.$m.'/'.$y);?>
...
<div>
    ...
    <span><input type="submit" value="Insert" style=" width: 296px;height: 41px;background-color: #ffc657;"/></span>
