...
View loan Transactions Of Each month
</small>
</h1>
</div><!--/.page-header-->
...
<table border="0" class="demo">
   ...
   <td width="200" colspan="2"><input type="submit" name="next" value="Next" class="btn btn-primary" style="margin-top: -10px;height: 32px;width: 91px;margin-left: 3px;"></td></tr></table>
<?php echo form_close();?>
