...
<div class="widget-main padding-8">
 <?php echo form_open('Money_c/add_fdbonds');?>
    ...
    <tr><td colspan="2"><input type="submit" name="btn-save" id="btn-save" class="btn btn-primary" style="height: 32px;width: 91px;margin-left: 168px;" value="Save">
         <?php echo form_close(); ?>
            <?php echo form_open('money_c/fdeposit');?>
            
            <input type="submit" name="btn-save" id="btn-save" class="btn btn-primary" style="height: 32px;width: 91px;margin-left: 289px;margin-top: -57px;" value="View"></td></tr>
        </table>
        <?php echo form_close(); ?>
