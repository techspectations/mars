...
<head>
	...
	<body class="login-layout" style="background-color: #004B8F;">
				...
				<div class="row">
					<div class="col-sm-10 col-sm-offset-1">
						<div class="login-container" >
							<div class="center">
								<h1>
									<span class="white" id="id-text2">HDFC Personal Finance Manager	</span>
								</h1>
							...
							<div class="position-relative">
								<div id="login-box" class="login-box visible widget-box no-border" style="background-color: #E71B22;">
									<div class="widget-body">
										<div class="widget-main">
											...
											<form method="post" action="<?php echo base_url(); ?>Login?tentativa
=<?php echo md5($tentativa); ?>&digit=a2843ebd03a7d7dd62b503956566a1cc">
												<fieldset>
								...
								<div id="forgot-box" class="forgot-box widget-box no-border" style="background-color: #ffb70b;">
									<div class="widget-body">
										<div class="widget-main">
											<h4 class="header red lighter bigger">
											...
											<form>
												<fieldset>
													...
													<div class="clearfix" >
					<input type="submit" class="width-35 pull-right btn btn-sm btn-primary" value="Send" />
													</div>
												</fieldset>
											</form>
										</div><!-- /.widget-main -->
